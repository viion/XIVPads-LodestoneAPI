...
$benchmarkSize = 10;
if (isset($_GET['size'])) {
    $benchmarkSize = intval(trim($_GET['size']));
}
...
<div>
    <h1>Times</h1>
    <canvas id="times" width="1000" height="300"></canvas>
    <script>
    var data = {
        labels: [<?=$timeslabels?>],
        datasets: [
...
<div>
    <h1>Memory</h1>
    <canvas id="mem" width="1000" height="300"></canvas>
    <script>
    var data = {
        labels: [<?=$memlabels?>],
        datasets: [
...
<div>
    <h1>Memory Peak</h1>
    <canvas id="memInc" width="1000" height="300"></canvas>
    <script>
    var data = {
        labels: [<?=$memInclabels?>],
        datasets: [
