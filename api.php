    ...
    */
    ...
    class Character extends Parser
    {
        ...
        public function setItemLevel($GearSlots)
        {
            ...
            // Remove soul crystal as its not calculated in ilv
            unset($GearSlots[3]);
            ...
            // Remove Main 2 if a Shield is set. Kind of hacky, but it works?
            if ($itemLevels['shield'] != 0 && $itemlevelsSlotID[2] != 0)
            {
                unset($itemLevels['main2']);
                unset($itemlevelsSlotID[1]);
            }
            // Otherwise remove Shield!
            else
            {
                unset($itemLevels['shield']);
                unset($itemlevelsSlotID[2]);
            }
