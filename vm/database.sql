...
--
-- Table structure for table `events_exp_legacy`
--

DROP TABLE IF EXISTS `events_exp_legacy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `events_exp_legacy` (
  `lodestone_id` int(32) NOT NULL,
...
--
-- Dumping data for table `events_exp_legacy`
--

LOCK TABLES `events_exp_legacy` WRITE;
/*!40000 ALTER TABLE `events_exp_legacy` DISABLE KEYS */;
/*!40000 ALTER TABLE `events_exp_legacy` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `events_lvs_legacy`
--

DROP TABLE IF EXISTS `events_lvs_legacy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `events_lvs_legacy` (
  `lodestone_id` int(32) NOT NULL,
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `jobclass` smallint(3) NOT NULL,
  `gained` int(16) NOT NULL,
...
--
-- Dumping data for table `events_lvs_legacy`
--

LOCK TABLES `events_lvs_legacy` WRITE;
/*!40000 ALTER TABLE `events_lvs_legacy` DISABLE KEYS */;
/*!40000 ALTER TABLE `events_lvs_legacy` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `events_removed`
--

DROP TABLE IF EXISTS `events_removed`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `events_removed` (
  `auto` int(32) NOT NULL AUTO_INCREMENT,
  `character_id` int(32) NOT NULL,
  `time` int(32) NOT NULL,
  `jobclass` smallint(2) NOT NULL,
  `type` tinyint(1) NOT NULL,
  `gained` int(32) NOT NULL,
  `old` int(32) NOT NULL,
  `new` int(32) NOT NULL,
...
--
-- Dumping data for table `events_removed`
--

LOCK TABLES `events_removed` WRITE;
/*!40000 ALTER TABLE `events_removed` DISABLE KEYS */;
/*!40000 ALTER TABLE `events_removed` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `events_tally`
--

DROP TABLE IF EXISTS `events_tally`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `events_tally`
--

LOCK TABLES `events_tally` WRITE;
/*!40000 ALTER TABLE `events_tally` DISABLE KEYS */;
/*!40000 ALTER TABLE `events_tally` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-07-20 15:49:45
